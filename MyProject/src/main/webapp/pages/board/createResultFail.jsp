		...
		<div class="row">
			...
			<div class="col s6">
				<div class="valign-wrapper center-align" style="height: 600px">
					<h3>이미 운영중인 게시판이 존재합니다.</h3>
				</div>
				<div class="center-align">
					<a href="/MyProject/pages/board/<%= loginInfo.getManageBoard() %>.board?userBoard=<%= loginInfo.getManageBoard() %>" class="btn-large z-depth-0 yellow darken-3">바로가기</a>
